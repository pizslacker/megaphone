...
However, we can make our C program smart. We can use a special POSIX function called isatty() (is-a-TTY/Teletype) to let the program look at its stdin and figure out: "Is a human typing at a keyboard, or is a machine feeding me data through a pipe?"
